...
<header id="header">
    ...
    if (Yii::$app->user->isGuest){
        $items=[
            ['label' => 'Каталог', 'url' => ['/product/catalog?sort=-date']],
        ...
        Yii::$app->user->identity->admin==1 ?
            ...
            ($items=[
                ...
                ['label' => 'Заказы', 'url' => ['/order/index?OrderSearch[user_id]='.Yii::$app->user->identity->id_user]],
]);
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <script src="../../web/js/add_product.js"></script>
